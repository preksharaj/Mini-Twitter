-- People
INSERT INTO people (id, pwd, handle, name)
VALUES
    (1, 'neha1', 'neha', 'Neha Kuol'),
    (2, 'paul2', 'paul', 'Paul Mitchell'),
    (3, 'sara', 'sara', 'Sara Bryant'),
    (4, 'tom', 'tom', 'Tom Bradley'),
    (5, 'lisa', 'lisa', 'Lisa Smith'),
    (6, 'derek', 'derek', 'Derek Thomas'),
    (7, 'daniel', 'daniel', 'Daniel Collin'),
    (8, 'tina', 'tina', 'Tina Steel'),
    (9, 'tony', 'tony', 'Tony Stark'),
    (10, 'anna', 'anna', 'Anna Charlsworth');
